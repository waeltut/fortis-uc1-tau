...
class HumanCostManager(Node):
    def __init__(self):
        super().__init__('human_cost_manager')
        ...
        # Publishers
        self.human_cost_publisher_ = self.create_publisher(UInt8MultiArray, '/global_costmap/global_costmap/human_costs', 1)
        self.human_grid_publisher_ = self.create_publisher(OccupancyGrid, '/costmaps_manager/human_costs', 1)
        ...
        self.get_logger().info('Human Costmap Manager is initilized')
    ...
    def costs_publisher(self):
        ...
        msg_cost.data = costs
        self.human_cost_publisher_.publish(msg_cost)
        ...
        msg_grid.data = data
        self.human_grid_publisher_.publish(msg_grid)
