...
def generate_launch_description():
    ...
    left_velocity_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["left_forward_velocity_controller", "--controller-manager", "/controller_manager"],
        output="screen",
    )
    ...
    right_velocity_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["right_forward_velocity_controller", "--controller-manager", "/controller_manager"],
        output="screen",
    )
    ...
    # Update delay_controllers to use new spawners
    ...
    # Add to ld
    ld.add_action(cartesian_to_joint_velocity_node)
